...
class TelaProfissional:
    def init(self, controlador_profissional):
    ...
    def cadastrar(self):
        try:
            ...
            self.controlador_profissional.cadastrar(profissional)
    ...
    def remover(self):
        try:
            ...
            self.controlador_profissional.remover(cpf)
    ...
    def alterar(self):
        try:
            ...
            self.controlador_profissional.alterar(cpf, nome, celular, especialidade, registro)
    ...
    def listar(self):
        try:
            profissionais = self.controlador_profissional.listar()
            print("\n=== PROFISSIONAIS ===")
